  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/add/users" method="post" class="" id="saved">
            @csrf
  ...
  <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/edit/users" method="post" class="" id="getForm">
            @csrf
            <div class="modal-body">
...
<script>
    ...
    function getDatafromDB(value){
        ...
        xhttp.open("GET","/api/Usersget/"+value);
        xhttp.send();
        // Updated Swal
    ...
    function deleteDatafromDB(value)
        {swal({
            ...
            xhttp.open("GET","/api/Userdelete/"+value);
            xhttp.send();
          }
        })
            ;
