            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped text-center" id="tableExport" style="width:100%;">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>User ID</th>
                    ...
                    <tbody>
                     @foreach ($Users_data as $value)
                        <tr>
                            ...
                            <td>{{$value->is_invited}}</td>
                            <td>{{$value->wallet_code}}</td>
                            <td>{{$value->status}}</td>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/add/student" method="post" class="" id="saved">
            @csrf
  ...
  <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/edit/student" method="post" class="" id="getForm">
            @csrf
            <div class="modal-body">
                ...
                <label for="status">Status</label>
                <input type="text" class="form-control" name="status" id="get_status">
                <label for="is_invited">Invited</label>
                <input type="text" class="form-control" name="is_invited" id="get_is_invited">
